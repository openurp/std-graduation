  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
        ...
        [@b.form class="navbar-form navbar-left" role="search" action="!doApply?batch.id="+degreeResult.batch.id]
            [@b.a class="btn btn-sm btn-info" href="!doApply"]<i class="fa-solid fa-plus"></i>申请[/@]
        [/@]
        </li>
    </ul>
    [/#if]
...
<div class="jumbotron">
    <div class="container">
        ...
        <p>
         [@b.a class="btn btn-lg btn-info" role="button" href="!doApply?batch.id="+degreeResult.batch.id]<i class="fa-solid fa-plus"></i>申请 ${program.degree.name}学位[/@]
        </p>
