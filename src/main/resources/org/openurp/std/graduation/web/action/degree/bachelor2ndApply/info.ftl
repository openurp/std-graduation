[#ftl]
[@b.toolbar title="${apply.std.name}的二学位申请信息"]
  bar.addBack();
[/@]
...
<table class="infoTable">
   ...
   <tr>
      <td class="title">公共基础课绩点</td><td>${apply.gpa?string("#.0000")}</td>
      <td class="title">学制</td><td>${std.duration}年</td>
      <td class="title">申请时间</td><td>${apply.updatedAt?string("yyyy-MM-dd HH:mm")}</td>
      <td colspan="2"></td>
   </tr>
   <tr>
      <td class="title">公共基础课程成绩</td>
      <td colspan="7">
        <pre>${apply.gradeDetail!}</pre>
      </td>
   </tr>
</table>
